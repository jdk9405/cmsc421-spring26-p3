...
import numpy as np
from utils import angle_bw, add_noise_laplace, add_noise_cauchy
...
class Car:
    ...
    def measure_gps(self, noise_dist="gaussian"):
        if noise_dist == "gaussian":
            ...
            self.gps_measurement = np.array([
                add_noise_laplace(self.pos[0], scale),
            ...
            self.gps_measurement = np.array([
                add_noise_cauchy(self.pos[0], scale),
                add_noise_cauchy(self.pos[1], scale)
            ])
        else:
